...
export function generateWorkout(args) {
    const { muscles, choice: workout, goal } = args;
  
    console.log("Arguments received in generateWorkout: ", args);
    ...
    if (workout === "individual") {
      ...
      if (WORKOUTS[workout]) {
        ...
        console.log("WORKOUTS structure doesn't match.");
        return [];
      }
    }
    ...
    console.log("Compound Exercises: ", compoundExercises);
    console.log("Accessory Exercises: ", accessoryExercises);
    ...
    console.log("Generated WOD: ", genWOD);
