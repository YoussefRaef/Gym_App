...
export default function ExerciseCard(props) {
  ...
  return (
    <div
    className='p-4 rounded-md flex flex-col gap-4 bg-slate-950
    sm:flex-wrap'>
        <div className='flex flex-col sm:flex-row sm:tems-center
        sm:flex-wrap gap-x-4'>
            ...
            max-w-full text-lg sm:text-xl md:text-2xl flex-1 sm:text-center'>
        ...
        gap-2'>
           ...
           <button onClick={handleSetCount} className='flex flex-col p-2 rounded border-[2px] duration-200 border-solid
           border-blue-200 hover:border-blue-600 w-full '>
